...
if platform == "darwin": # testa hemma
    system = "mac"
elif platform == "win32":
    system = "win"
...
def restart(code_run, name_or_numb):
    ...
    def coderunner(new_value):
        try:
            ...
            if system == "win":
                name_of_tut = "C:/Users/22gusgam/OneDrive - ABB Gymnasiet/Programmeringen är i denna foldern/Python (kopia)/Code_storage/pfc/" + all_tutorials[int(name_or_numb) - 1]+".py"
                print(name_of_tut)
